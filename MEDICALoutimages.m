...
% Reading input image
% IMG=[Img1 Img2 Img3];
a=0.95;                                          % Default value of Noise density
for i=1:1
  if i==1
  Img=  imread('lungs.jpg');
  elseif i==2
      a=.85;
...
imwrite(nImg,'work2noisyimage.tif');
imwrite(DBAMF_OutImg,'work21DBAMF_OutImg.tif');
imwrite(mdbutm_OutImg,'work22mdbutm_OutImg.tif');
imwrite(fsbmmf_OutImg,'work23fsbmmf_OutImg.tif');
imwrite(RSIF_OutImg,'work24RSIF_OutImg.tif');
imwrite(ASWMF_OutImg,'work25ASWMF_OutImg.tif');
imwrite(TVWA_OutImg,'work26TVWA.tif');
imwrite(DAMF_OutImg,'work27DAMF_OutImg.tif');
imwrite(TVWA2final_OutImg,'work28PA.tif');
a
imshow('lungs.jpg');
